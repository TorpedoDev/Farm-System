                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="page-header-left">
                            <h3>@lang('hometr.Edit sell chicken')</h3>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item active">@lang('hometr.Edit sell chicken')</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h5>@lang('hometr.Edit data of sell chicken')</h5>
                        </div>
                        <div class="card-body">
                            <div class="digital-add needs-validation">
                                ...
                                @endif
                                <form action="{{ route('checkensales.update' , $chickensale ) }}" method="POST">
                                    @method('put')
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('weights') is-invalid @enderror" type="text"
                                            name="weights" value="{{ $chickensale->weights }}" required>
                                        @error('weights')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('kilo_price') is-invalid @enderror" type="text"
                                            name="kilo_price" value="{{ $chickensale->kilo_price }}" required>
                                        @error('kilo_price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
