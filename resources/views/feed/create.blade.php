                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item active">@lang('hometr.Enter feed')</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h5>@lang('hometr.Enter data to buy feed')</h5>
                        </div>
                        <div class="card-body">
                                ...
                                <form action="{{ route('feed.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="validationCustom01" class="col-form-label pt-0"><span>*</span>
                                            @lang('hometr.Feed qunatity')</label>
