                            ...
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true"><span class="icon-user me-2"></span>@lang('hometr.Login')</a>
                                </li>
                            </ul>
                                    ...
                                    <form class="form-horizontal auth-form" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            <input id="email" type="email"
                                                ...
                                                value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="@lang('hometr.Email')">
                                            @error('email')
                                        ...
                                        <div class="form-group">
                                            <input id="password" name="password" type="password"
                                                ...
                                                placeholder="@lang('hometr.Password')" required autocomplete="current-password">
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-terms">
                                            <div class="form-check mesm-2">
                                                ...
                                                <label class="form-check-label ps-2"
                                                    for="customControlAutosizing">@lang('hometr.Remember me')</label>
                                            </div>
                                        </div>
                                        <div class="form-button">
                                            <button class="btn btn-primary" type="submit">@lang('hometr.Login')</button>
                                        </div>
                                        <div class="form-footer">
                                            <span>@lang('hometr.You have to login first to use this system')</span>
                                            <ul class="social">
