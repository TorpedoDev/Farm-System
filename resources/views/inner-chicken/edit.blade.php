                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="page-header-left">
                            <h3>@lang('hometr.Edit chicken')</h3>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item active">@lang('hometr.Edit chicken')</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h5>@lang('hometr.Edit data of inner chicken')</h5>
                        </div>
                        <div class="card-body">
                            <div class="digital-add needs-validation">
                                ...
                                @endif
                                <form action="{{ route('chicken.update' , $chicken ) }}" method="POST">
                                    @method('put')
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('quantity') is-invalid @enderror" type="text"
                                            name="quantity" value="{{ $chicken->quantity }}" required>
                                        @error('quantity')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('salary') is-invalid @enderror" type="text"
                                            name="salary" value="{{ $chicken->salary }}" required>
                                        @error('salary')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
