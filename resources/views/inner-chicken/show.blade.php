                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <h3 class="marginright">In-{{ $chicken->id }}</h3>
                                    <span
                                        class="marginright">{{ \Carbon\Carbon::parse($chicken->created_at)->translatedFormat('l j F Y H:i') }}</span>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <p class="lead marginbottom"> @lang('hometr.Inner chicken bill') <br></p>
                                </div>

                                <div class="col-sm-3 text-right payment-details">
                                    <p class="lead marginbottom payment-info">@lang('hometr.Details')</p>
                                    <p>@lang('hometr.Date'):
                                        {{ \Carbon\Carbon::parse($chicken->created_at)->translatedFormat('l j F Y H:i') }}
                                    </p>
                                    <p>@lang('hometr.Total salary'): {{ $chicken->total }}
                                        @lang('hometr.pound')</p>
                                </div>
                            </div>
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-right" style="width:15%">@lang('hometr.Chicken number')</th>
                                            <th class="text-right" style="width:15%">@lang('hometr.Chicken salary')</th>
                                            <th class="text-right" style="width:15%">@lang('hometr.Total salary')</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="text-center">1</td>
                                            <td class="text-right">{{ $chicken->quantity }} @lang('hometr.Chicken')</td>
                                            <td class="text-right">{{ $chicken->salary }} @lang('hometr.pound')
                                            </td>
                                            <td class="text-right">
                                                {{ $chicken->total }}
                                                @lang('hometr.pound')</td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        $(function() {
            $("#btnPrint").click(function() {
                ...
                frameDoc.document.write(
                    '<html lang="{{ LaravelLocalization::getCurrentLocale() }}" dir="{{ LaravelLocalization::getCurrentLocaleDirection() }}"><head><title>Re-{{ $chicken->id }}</title>');
