                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="page-header-left">
                            <h3>@lang('hometr.Edit cartoon')</h3>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h5>@lang('hometr.Edit data of cartoon')</h5>
                        </div>
                        <div class="card-body">
                            <div class="digital-add needs-validation">
                                ...
                                @endif
                                <form action="{{ route('cartoon.update' , $cartoon ) }}" method="POST">
                                    @method('put')
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('quantity') is-invalid @enderror" type="text"
                                            name="quantity" value="{{ $cartoon->quantity }}" required>
                                        @error('quantity')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('salary') is-invalid @enderror" type="text"
                                            name="salary" value="{{ $cartoon->salary }}" required>
                                        @error('salary')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
