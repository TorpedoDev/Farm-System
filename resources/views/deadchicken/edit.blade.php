                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="page-header-left">
                            <h3>@lang('hometr.Edit dead chicken')</h3>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h5>@lang('hometr.Enter data to edit dead chicken')</h5>
                        </div>
                        <div class="card-body">
                            <div class="digital-add needs-validation">
                                ...
                                @endif
                                <form action="{{ route('deadchicken.update' , $deadchicken ) }}" method="POST">
                                    @method('put')
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('number') is-invalid @enderror" type="text"
                                            name="number" value="{{ $deadchicken->number }}" required>
                                        @error('number')
