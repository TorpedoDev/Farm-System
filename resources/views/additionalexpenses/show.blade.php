                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <h3 class="marginright">In-{{ $additional->id }}</h3>
                                    <span
                                        class="marginright">{{ \Carbon\Carbon::parse($additional->created_at)->translatedFormat('l j F Y H:i') }}</span>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <p class="lead marginbottom"> @lang('hometr.additional bill') <br></p>
                                </div>

                                <div class="col-sm-3 text-right payment-details">
                                    <p class="lead marginbottom payment-info">@lang('hometr.Details')</p>
                                    <p>@lang('hometr.Date'):
                                        {{ \Carbon\Carbon::parse($additional->created_at)->translatedFormat('l j F Y H:i') }}
                                    </p>
                                    <p>@lang('hometr.Total salary'): {{ $additional->salary }}
                                        @lang('hometr.pound')</p>
                                </div>
                            </div>
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-right" style="width:15%">@lang('hometr.additional salary')</th>
                                            <th class="text-right" style="width:15%">@lang('hometr.additional date')</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right">{{ $additional->salary }} @lang('hometr.pound')
                                            </td>
                                            <td class="text-right">{{$additional->created_at }}</td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        $(function() {
            $("#btnPrint").click(function() {
                ...
                frameDoc.document.write(
                    '<html lang="{{ LaravelLocalization::getCurrentLocale() }}" dir="{{ LaravelLocalization::getCurrentLocaleDirection() }}"><head><title>Re-{{ $additional->id }}</title>');
